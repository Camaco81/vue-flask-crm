<template>
 ...
 <div class="form-group">
  ...
  <AutocompleteSearch
   :items="customers"
   placeholder="Buscar cliente por nombre o cédula..."    labelKey="fullSearchKey"
   valueKey="id" 
...
export default {
 ...
 // 💡 AJUSTE CLAVE: Usamos 'cedula' y simplificamos la clave de búsqueda.
 this.customers = customersResponse.data.map(c => ({
   ...c,
   cedula: c.cedula || 'N/A', // 💡 Usando 'cedula' según la BD.
   // Creamos una clave combinada para la búsqueda en AutocompleteSearch
   // Solo nombre y cedula
 ...
 // La función generateInvoicePdf fue corregida en la respuesta anterior
...
<style scoped>
/* Estilos CSS (sin cambios, omitido para brevedad) */
/* ... (Se mantiene el <style scoped> original) */
</style>
